...
**Config**: `core/config/graphrag.py` → `GraphExtractionConfig`
...
**Agent**: `business/agents/graphrag/entity_resolution.py`  
...
**Agents**: `business/agents/graphrag/community_detection.py`, `business/agents/graphrag/community_summarization.py`  
