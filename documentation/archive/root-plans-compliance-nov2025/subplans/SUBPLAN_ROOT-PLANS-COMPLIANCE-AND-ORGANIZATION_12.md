...
- All EXECUTION_TASK files follow `EXECUTION_TASK_<FEATURE>_<SUBPLAN>_<EXECUTION>.md` pattern
- All EXECUTION_ANALYSIS files follow `EXECUTION_ANALYSIS_<TOPIC>.md` pattern
