...
**When to Use**: See `documentation/guides/GRAMMAPLAN-GUIDE.md`
...
- **GrammaPlan Guide**: `documentation/guides/GRAMMAPLAN-GUIDE.md`
- **Multiple Plans Protocol**: `documentation/guides/MULTIPLE-PLANS-PROTOCOL.md`
...
**For Help**: See `documentation/guides/GRAMMAPLAN-GUIDE.md`
