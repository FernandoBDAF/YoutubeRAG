...
Use GrammaPlan when **TWO OR MORE** of these indicators apply:
...
| ---------------- | ----------------- | ---------------------------------- |
| **Size**         | < 800 lines       | 800+ lines (split across children) |
| **Effort**       | < 80 hours        | 80+ hours                          |
| **Domains**      | 1-2               | 3+                                 |
...
1. **Identify Need**:
   ...
   - PLAN draft exceeds 800 lines OR
   - Work spans 3+ domains OR
   - Estimated >80 hours OR
