...
**Naming**: `SUBPLAN_<FEATURE>_<NUMBER>.md` (e.g., `SUBPLAN_OPTIMIZE-EXTRACTION_01.md`)
...
- Examples:
  - `EXECUTION_TASK_OPTIMIZE-EXTRACTION_01_01.md` - First execution of subplan 01
  - `EXECUTION_TASK_OPTIMIZE-EXTRACTION_01_02.md` - Second execution of subplan 01 (new strategy after circular debug)
  - `EXECUTION_TASK_OPTIMIZE-EXTRACTION_02_01.md` - First execution of subplan 02
...
- Achievement 1.1: IMPLEMENTATION_START_POINT.md
- Achievement 1.2: IMPLEMENTATION_END_POINT.md
...
subplans/
  ├── SUBPLAN_STRUCTURED-LLM-DEVELOPMENT_01.md
  ├── SUBPLAN_STRUCTURED-LLM-DEVELOPMENT_02.md
  └── ... (all 12 subplans)
