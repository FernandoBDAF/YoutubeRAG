...
def rerank_hits(
    ...
    # Combine vector score with trust_score and recency (age_days inverse)
...
def answer_with_openai(contexts: List[Dict[str, Any]], question: str) -> str:
    # Optional: if OPENAI_API_KEY present, call a small model; otherwise return concatenated context
...
if __name__ == "__main__":
    load_dotenv()
    out = rag_answer("What are React state management best practices?", k=5)
    print(out["answer"])
