...
def handle_stage_errors(stage_name: Optional[str] = None) -> Callable:
    ...
    def decorator(func: Callable) -> Callable:
        @functools.wraps(func)
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            from core.libraries.error_handling.exceptions import StageError
...
def handle_agent_errors(agent_name: Optional[str] = None) -> Callable:
    ...
    def decorator(func: Callable) -> Callable:
        @functools.wraps(func)
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            from core.libraries.error_handling.exceptions import AgentError
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            try:
                ...
                from core.libraries.error_handling.exceptions import wrap_exception
