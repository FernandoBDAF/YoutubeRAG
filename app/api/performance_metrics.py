        ...
        trends.append(
            {
                ...
                "timestamp": (
                    started_at.isoformat() if isinstance(started_at, datetime) else str(started_at)
                ),
...
if __name__ == "__main__":
    ...
    logger.info(
        f"✅ Performance metrics API server started on http://0.0.0.0:{port}/api/performance"
    )
