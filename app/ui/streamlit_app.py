...
from business.services.rag.rag import rag_answer
...
def main() -> None:
    ...
    try:
        from business.services.rag.profiles import list_profiles
        ...
        # Quick save preset
        try:
            from business.services.rag.profiles import upsert_profile
    ...
    with tab_qna:
        ...
        if st.button("Search", key="qna_search"):
            with st.spinner("Retrieving..."):
                ...
                from business.services.rag.rag import rag_hybrid_answer
    ...
    with tab_vector:
        ...
        from business.services.rag.rag import embed_query, vector_search
    ...
    with tab_hybrid:
        ...
        from business.services.rag.rag import embed_query
        from business.services.rag.retrieval import hybrid_search
    ...
    with tab_lab:
        ...
        from business.services.rag.retrieval import keyword_search, structured_search
        ...
        if st.button("Run Lab", key="lab_run") and q_lab.strip():
            with st.spinner("Running modes..."):
                try:
                    ...
                    from business.services.rag.rag import vector_search as _vs
    ...
    with tab_ctrl:
        ...
        with st.expander("Persona & Session"):
            client = get_mongo_client()
            db = client[DB_NAME]
            from business.services.rag.utils import ensure_user_profiles

            ensure_user_profiles(db)
            from business.services.rag.profiles import (
                list_profiles,
                upsert_profile,
                delete_profile,
                get_profile,
